...
- Plataforma: Especifique a plataforma (ex: shopify-next, hotmart-v2, wooocommerce, etc). Veja na descrição do campo a lista de plataformas suportadas.**Observação:** Apenas integrações que forem criadas com plataforma api-next podem adicionar ou remover leads da sua lista de leads pela API. 
