...
export const integrationsFields: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: ['get_integration', 'delete_integration', 'edit_integration'],
			},
		},
	...
	},
	{
		...
		placeholder: 'Choose',
		options: [
			{ name: 'Available Events', value: 'available_events' },
		...
		routing: {
			request: { qs: { append: '={{ $value && $value.length ? $value.join(",") : undefined }}' } },
		},
	},
];
