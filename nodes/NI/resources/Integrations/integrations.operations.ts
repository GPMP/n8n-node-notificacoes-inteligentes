						...
						postReceive: [
							async function (this, items, response) {
								...
								throw new NodeApiError(
									...
									{},
									{
										message: `Error ${response.statusCode}: ${response.body?.message || 'Could not create the integration'}`,
						...
						postReceive: [
							async function (this, items, response) {
								...
								throw new NodeApiError(
									...
									{},
									{
										message: `Error ${response.statusCode}: ${response.body?.message || 'Could not edit the integration'}`,
										httpCode: String(response.statusCode),
									},
								);
							},
						...
						postReceive: [
							async function (this, items, response) {
								...
								throw new NodeApiError(
									...
									{},
									{
										message: `Error ${response.statusCode}: ${response.body?.message || 'Could not delete the integration'}`,
										httpCode: String(response.statusCode),
									},
								);
							},
