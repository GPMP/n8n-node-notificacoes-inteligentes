...
export const leadsFields: INodeProperties[] = [
	...
	{
		displayName: 'You must include the plus sign (+) prefix with the number; Ex: +55, +1',
		name: 'notice',
		type: 'notice',
		default: '',
		displayOptions: {
		...
		description: 'You must include the plus sign (+) prefix with the number. Examples: +55, +1.',
	},
	...
	},
	{
		...
		options: [
			{
				...
				default: '',
				description:
					'Collecting information about a users browser and device from the "User Agent" string it sends to websites',
			},
			{
			...
			},
			{
				...
				default: '',
				description:
					'It identifies a users browser and device for website customization and analytics',
			},
			{
		...
		description: 'Tracking data for attribution and analytics purposes',
		routing: {
			send: {
				preSend: [
					async function (this: any, requestOptions) {
						// Tracking data is handled inside the preSend of each operation.
						// This field only collects the values from the user.
